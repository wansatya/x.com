        ...
        <div className="flex flex-col justify-between h-screen xl:pr-3 fixed overflow-y-auto w-68 xs:w-88 xl:w-275">
          ...
          <div>
            ...
            <nav className="mt-5">
              ...
              <Link to="/games"
                className={`flex items-center justify-center xl:justify-start ${location.pathname === '/games' ? 'text-amber-400' : 'text-white hover:text-amber-400'} transition duration-350 ease-in-out p-2 mb-2 md:hover:bg-slate-800 rounded-xl`}>
                <TbBulb className="h-6 w-6 text-white" />
                <span className="hidden xl:block ml-4 font-bold text-md">Games</span>
              </Link>
            </nav>
          </div>
